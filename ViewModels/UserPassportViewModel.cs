...
namespace WordAndSQL_Core.ViewModels
{
    ...
    {
        string sqlConnection = "Data Source=CALKIO\\;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        public Users GetDataUsers()
        {
            ...
            {
                MessageBox.Show("Ошибка подключения к базе данных", "Exception Sample", MessageBoxButton.OK, MessageBoxImage.Warning);
